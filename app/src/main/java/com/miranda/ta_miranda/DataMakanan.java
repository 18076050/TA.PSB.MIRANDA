package com.miranda.ta_miranda;
...
public class DataMakanan {
    ...
    private static String[] detailMakanan = {
            "Nasi Kapau adalah nasi ramas khas nagari Kapau, Tilatang Kamang, Kabupaten Agam, Sumatra Barat, terdiri dari nasi, sambal, dan lauk pauk khas Kapau, gulai sayur nangka, gulai tunjang, gulai cangcang, gulai babek atau paruik kabau. Nasi kapau standar selalu dilengkapi gulai nangka ciri khas nasi kapau. ",
